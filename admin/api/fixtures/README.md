...
| --- | --- | --- | --- |
| `0001_user.json` | `auth.user` | 3 | The `admin` superuser plus `Boris` and `Pavel`, the two ordinary users who own the people. Passwords are hashed here; the root README has the plaintext. |
